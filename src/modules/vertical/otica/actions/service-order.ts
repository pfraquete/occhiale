...
import { updateServiceOrderStatus as updateStatusQuery, getServiceOrderById } from "@/shared/lib/supabase/queries/service-orders";
import { ServiceOrderStatus } from "@/shared/lib/supabase/queries/service-orders";
import { revalidatePath } from "next/cache";
import { createClient } from "@/shared/lib/supabase/server";
import { sendOSStatusNotification } from "@/modules/core/whatsapp/lib/evolution/notifications";
